...
open class SCLAlertView: UIViewController {
    ...
    public struct SCLAppearance {
        ...
        public init(showCircularIcon: Bool, kCircleIconHeight: CGFloat, kCircleHeight: CGFloat, showCloseButton: Bool, shouldAutoDismiss: Bool, hideWhenBackgroundViewIsTapped: Bool) {
            
            self.kDefaultShadowOpacity = 0.7
            self.kCircleTopPosition = -12.0
            self.kCircleBackgroundTopPosition = -15.0
            self.kCircleHeight = kCircleHeight
            self.kCircleIconHeight = kCircleIconHeight
            self.kTitleTop = 30.0
            self.kTitleHeight = 25.0
            self.kWindowWidth = 240.0
            self.kWindowHeight = 178.0
            self.kTextHeight = 90.0
            self.kTextFieldHeight = 45.0
            self.kTextViewdHeight = 80.0
            self.kButtonHeight = 45.0
            self.contentViewColor = UIColorFromRGB(0xFFFFFF)
            self.contentViewBorderColor = UIColorFromRGB(0xCCCCCC)
            self.titleColor = UIColorFromRGB(0x4D4D4D)
            
            self.kTitleFont = UIFont.systemFont(ofSize: 20)
            self.kTextFont = UIFont.systemFont(ofSize: 14)
            self.kButtonFont = UIFont.boldSystemFont(ofSize: 14)
            
            self.showCloseButton = showCloseButton
            self.showCircularIcon = showCircularIcon
            self.shouldAutoDismiss = shouldAutoDismiss
            self.contentViewCornerRadius = 5.0
            self.fieldCornerRadius = 3.0
