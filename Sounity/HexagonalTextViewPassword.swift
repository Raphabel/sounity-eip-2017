//
//  HexagonalTextViewPassword.swift
//  Sounity
//
...
open class HexagonalTextFieldPassword : UITextField {
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        self.attributedPlaceholder = NSAttributedString(string:"Password", attributes:[NSForegroundColorAttributeName: UIColor.gray])
        self.background = UIImage(named: "TextFieldPassword")
    }
}
